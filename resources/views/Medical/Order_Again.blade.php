        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('again_order_med/'.$again_order_med->id) }}" method="POST">
                        @csrf
                        @method('POST')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="cname" value="{{$again_order_med->cname}}" class="form-control" >
                            @error('cname')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="address" value="{{$again_order_med->address}}" class="form-control">
                            @error('address')
                            <span class="text-danger"><b> {{$message}} </b></span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="phone" value="{{$again_order_med->phone}}" class="form-control">
                            @error('phone')
                            <span class="text-danger"><b> {{$message}}</b> </span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="name" value="{{$again_order_med->name}}" class="form-control" readonly>
                        </div>
                        <div class="form-group mb-3">
                            <label for=""><b>Medicine's Disease:</b></label>
                            <input type="text" name="disease" value="{{$again_order_med->disease}}" class="form-control" readonly>
                        </div>
                        <div class="form-group mb-3">
                            <label for=""><b>Medicine's Details:</b></label>
                            <label>{{$again_order_med->details}}</label>
                        </div>
                        <div class="form-group mb-3">
                            <label for=""><b>Medicine's Price:</b></label>
                            <input type="text" name="price" value="{{$again_order_med->price}}" class="form-control" readonly>
                        </div>
                        <div class="form-group mb-3">
