...
<div class="container">
	...
	<body>
		<fieldset>
			<form action="{{ route('check_admin_login') }}" method="post">
            @csrf
				...
				<tr><td></td></tr>
					...
					<td colspan="2" align="center"><a href ="{{url('/home')}}" style="text-decoration:none; color:rgb(102, 0, 204)" >
						<h3 style=""><b> &nbsp; Beximco Pharmaceuticals Ltd. &nbsp; <br></b></h3></td>
				</tr>			
				<tr>
					<td colspan="2" align="center"><h4 style="color:brown"><b> &nbsp; Admin Login &nbsp; <br></b></h4></td>
				</tr>
					</tr>
					<tr>
					...
					<tr> <td align="right"><b> User Name: </td>
						<td align="center"><input name="aname"  placeholder="Username" type="text"><br>
                        @error('aname')
					...
					<tr>
						<td colspan="2" align="center"><a style="text-decoration:none; color: rgb(128, 0, 255)" href ="Forgot_Password.html">Forgot password? </a></td>
					</tr>	
